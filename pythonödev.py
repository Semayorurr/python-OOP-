...
class kitap(kaynak):
    ...
    def __str__(self):
        return (f'Kitabın başlığı:{self.baslik}\n'
               f'kitabın yazarı:{self.yazar}\n'
               f'Kitabın türü:{self.tür}\n'
               f'Kitabın baskı sayısı:{self.baskiSayisi}\n'
               f'Kitabın kayıt numarası:{self.kayitNo}\n'
               f'Kitabın sayfa sayısı:{self.sayfaSayisi}\n'
               f'Kitabın yayın tarihi:{self.yayinTarihi}\n'
               f'Kitabın yayınevi:{self.yayinEvi}\n')
    @property
    def yazar(self):
        return self._yazar
    @yazar.setter
...
class dergi(kaynak):
    def __init__(self,baslik,kayitNo,sayfaSayisi,yayinTarihi,yayinEvi,sayiNo,editör):
        ...
        self.editör=editör
    def __str__(self):
        return (f'Derginin başlığı:{self.baslik}\n'
               f'Derginin sayı numarası:{self.sayiNo}\n'
               f'Derginin editörü:{self.editör}\n'
               f'Derginin kayıt numarası:{self.kayitNo}\n'
               f'Derginin sayfa sayısı:{self.sayfaSayisi}\n'
               f'Derginin yayın tarihi:{self.yayinTarihi}\n'
               f'Derginin yayınevi:{self.yayinEvi}\n')
    @property
    def sayiNo(self):
        return self._sayiNo
    @sayiNo.setter
...
class kitapİslem(islem):
    ...
    def ekle(self):
        ...
        for i in self.kitaplar:
            if i.kayitNo==kayitNo:
                print("Aynı kayıt numarasına sahip kitap ekleyemezsiniz!!!")
                return
    ...
    def sil(self):
        ...
        KayitNo=int(input("silmek istediDerginin kayıt numarasını giriniz: "))
        for i in self.kitaplar:
            if i.kayitNo==KayitNo:
                print("kayıt bulundu")
    ...
    def guncelle(self):
        ...
        KayitNo=int(input("Değişiklik yapmak istediğiniz kitabın kayıt numarasını giriniz:"))
        for i in self.kitaplar:
            if i.kayitNo==KayitNo:
...
class dergiİslem(islem):
    ...
    def ekle(self):
        ...
        for i in self.dergiler:
            if i.kayitNo==kayitNo:
                print("aynı kayıt numarasına sahip dergi ekleyemezsiniz!!!")
                return
